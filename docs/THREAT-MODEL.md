...
| T-19 | Compromised adapter | Execution path ≠ monitor identity | Canonical deny, wrong file mutated | High | PARTIALLY TESTED | v0.3 review: FakeAdapter.pop uses request string | Phase 1 v0.3 review | Execution vs security identity | Phase 1 adapter not fully aligned |
